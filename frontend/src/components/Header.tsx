...
interface HeaderProps {
  ...
  setActiveDateTab: (tab: string) => void;
    ...
    <header className="bg-white border-b border-slate-200 sticky top-0 z-40 px-4 py-3 shadow-xs">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <button onClick={onOpenSidebar} className="p-1 text-slate-800 hover:bg-slate-100 rounded-lg">
        ...
        <div className="flex items-center space-x-2.5">
          ...
          <button
            onClick={() => { setActiveDateTab("LIVE"); setCustomDate(""); setCurrentPage(1); }}
